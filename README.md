...
```
4. Установить библиотеку pandas:
```
poetry add pandas
```
...
4. Создан модуль tables, написаны функции для чтения файлов в формате -csv и -exlsx
5. Создан модуль regular_exspressions, написаны функции для работы с регулярными выражиниями и подсчета количества операций.
6. В модуле main в корне проекта реализована главная функция.
